...
import { getBusinessById, getBusinessReviews } from "@/lib/data";
        ...
        <div className="absolute top-0 left-0 right-0 pt-14 px-5 flex justify-between items-center">
          ...
          <div className="flex gap-2">
            ...
            <div
              ...
              style={{ background: "rgba(255,255,255,0.92)" }}
            >
              <svg width="17" height="17" viewBox="0 0 24 24" fill="#C8860A">
                <path d="M6 4h12v16l-6-4-6 4V4Z" stroke="#C8860A" strokeWidth="2" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-[390px] mx-auto px-5 pb-12">
        ...
        <div className="pt-4">
          ...
          <div className="flex items-center gap-1.5 mt-2">
            <span className="text-sm text-brand-gold">{"★".repeat(5)}</span>
            <span className="text-[13px] font-extrabold text-brand-dark">{business.rating}</span>
        ...
        <div className="flex gap-2 mt-4">
          ...
          <div className="flex-1 flex flex-col items-center gap-1.5 bg-white border border-brand-border text-brand-brown rounded-[14px] py-3">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
        ...
        <div className="mt-4 flex flex-col gap-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-[13px] text-brand-brown font-semibold">
              Open today ·{" "}
              {Object.entries(business.hours).slice(0, 2).map(([day, hours]) => `${day}: ${hours}`).join(", ")}
            </span>
          </div>
          <div className="flex items-center gap-3">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" className="flex-none">
        ...
        >
          ...
          <span className="absolute bottom-2.5 right-3 text-[11px] font-extrabold text-brand-gold rounded-full px-2.5 py-1" style={{ background: "rgba(255,255,255,0.95)" }}>
            View Full Map →
          </span>
        </div>
